                            ...
                            <div className="contactOptions">
                                ...
                                <a href="https://www.linkedin.com/in/taisia-mertz-6a3782224/" target="_blank">
                                    <button class="linkedInContactButton">
                                        <svg fill="white" viewBox="0 0 24 24" height="1.5em" width="1.5em" xmlns="http://www.w3.org/2000/svg"><path d="M22.23 0H1.77C.79 0 0 .79 0 1.77v20.46C0 23.21.79 24 1.77 24h20.46c.99 0 1.77-.79 1.77-1.77V1.77C24 .79 23.21 0 22.23 0zM7.53 20.48H3.56V9h3.97v11.48zM5.55 7.74a2.26 2.26 0 0 1-2.26-2.26 2.26 2.26 0 0 1 2.26-2.26c1.24 0 2.25 1.01 2.25 2.26a2.26 2.26 0 0 1-2.25 2.26zm15.25 12.74h-3.96v-5.57c0-1.33 0-3.06-1.86-3.06-1.87 0-2.15 1.46-2.15 2.96v5.67H9.88V9h3.81v1.56h.05c.53-.99 1.82-2.05 3.75-2.05 4.01 0 4.76 2.64 4.76 6.08v5.89z"></path></svg>
                                        <span class="linkedInContactLabel">@taisia mertz</span>
                                    </button>
                                </a>
                                <a href={resume} target="_blank" rel="noreferrer noopener">
                                    <button class="resumeContactButton">
                                        <svg fill="white" viewBox="0 0 25 25" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">
